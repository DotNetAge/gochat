...
func main() {
	// OpenAI
	openaiClient, err := openai.NewOpenAI(core.Config{
	...
	// Anthropic (Claude)
	anthropicClient, err := anthropic.NewAnthropic(core.Config{
	...
	ollamaClient, err := ollama.NewOllamaClient(core.Config{
		Model:   "llama2",
