	...
	return []DownloadModelInfo{
		{
			...
			Type: "bge",
			URLs: []string{
				"https://huggingface.co/onnx-community/bge-small-zh-v1.5-ONNX/blob/main/onnx/model_fp16.onnx",
				"https://huggingface.co/onnx-community/bge-small-zh-v1.5-ONNX/blob/main/onnx/model_fp16.onnx_data",
			},
			Size:        "~48MB",
		...
		},
		{
			...
			Type: "sentence-bert",
			URLs: []string{
				"https://huggingface.co/Xenova/all-MiniLM-L6-v2/blob/main/onnx/model_fp16.onnx",
			},
			Size:        "~45.3MB",
		...
		},
		{
			...
			Type: "bert",
			URLs: []string{
				"https://huggingface.co/Xenova/bert-base-uncased/blob/main/onnx/model_fp16.onnx",
			},
			Size:        "~200MB",
		...
		},
		{
			...
			Type: "bge",
			URLs: []string{
				"https://huggingface.co/Xenova/bge-base-zh-v1.5/blob/main/onnx/model_fp16.onnx",
			},
			Size:        "~100MB",
		...
		},
		{
			...
			Type: "sentence-bert",
			URLs: []string{
				"https://huggingface.co/Xenova/all-mpnet-base-v2/blob/main/onnx/model_fp16.onnx",
			},
			Size:        "~218MB",
